...
const savedMaterials = [
  { name: 'Premium Ilmenite Sand', origin: 'Mozambique', grade: 'TiO₂ 54%+', availability: '2,500 MT', tone: 'bg-mineral/10' },
  { name: 'High-Grade Graphite', origin: 'Madagascar', grade: 'TGC 96%+', availability: '800 MT', tone: 'bg-sand/5' },
]
